	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable()) // Disable CSRF
				.cors(cors -> cors.configurationSource(request -> {
					...
					config.setAllowedOrigins(Arrays.asList("http://localhost:4200", "https://ramaquatech.netlify.app"));
...
//						.requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html", "/v2/api-docs/**").permitAll()
